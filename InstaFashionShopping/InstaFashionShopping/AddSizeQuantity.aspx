<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddSizeQuantity.aspx.cs" Inherits="InstaFashionShopping.AddSizeQuantity" %>
    ...
    <div class="container ">
        <div class="form-horizontal ">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 ">
                    <asp:button id="btnAddSizeQuantity" runat="server" text="Add" backcolor="#009900" font-bold="False" font-size="12pt" forecolor="White" height="38px" width="85px" border-radius="5px" OnClick="btnAddSizeQuantity_Click"/>
                    <br />
                </div>
            </div>
        </div>
