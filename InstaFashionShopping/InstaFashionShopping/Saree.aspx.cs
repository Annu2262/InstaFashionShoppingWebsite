...
{
    public partial class Saree : System.Web.UI.Page
    {
        ...
        private void BindProductRepeater()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("procBindSarees", con))
                {
        ...
        protected void r2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select A.*,B.*,C.Name ,A.PPrice-A.PSelPrice as DiscAmount,B.Name as ImageName, C.Name as BrandName,D.CatName as CategoryName from Products A inner join Brand C on C.BrandID = A.PBrandID inner join Category D on D.CatID = A.PCategoryID cross apply( select top 1 * from ProductImages B where B.PID = A.PID order by B.PID desc)B where CatName='Saree'AND ( PSelPrice between 500 and 1000) order by A.PID desc";
                SqlCommand cmd = new SqlCommand(query, con);
                SqlDataReader dt = cmd.ExecuteReader();
        ...
        protected void r3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select A.*,B.*,C.Name ,A.PPrice-A.PSelPrice as DiscAmount,B.Name as ImageName, C.Name as BrandName,D.CatName as CategoryName from Products A inner join Brand C on C.BrandID = A.PBrandID inner join Category D on D.CatID = A.PCategoryID cross apply( select top 1 * from ProductImages B where B.PID = A.PID order by B.PID desc)B where CatName='Saree'AND ( PSelPrice between 1000 and 1500)order by A.PID desc";
                SqlCommand cmd = new SqlCommand(query, con);
                SqlDataReader dt = cmd.ExecuteReader();
        ...
        protected void r4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select A.*,B.*,C.Name ,A.PPrice-A.PSelPrice as DiscAmount,B.Name as ImageName, C.Name as BrandName,D.CatName as CategoryName from Products A inner join Brand C on C.BrandID = A.PBrandID inner join Category D on D.CatID = A.PCategoryID cross apply( select top 1 * from ProductImages B where B.PID = A.PID order by B.PID desc)B where CatName='Saree'AND ( PSelPrice between 1500 and 2000 )order by A.PID desc";
                SqlCommand cmd = new SqlCommand(query, con);
                SqlDataReader dt = cmd.ExecuteReader();
        ...
        protected void r5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select A.*,B.*,C.Name ,A.PPrice-A.PSelPrice as DiscAmount,B.Name as ImageName, C.Name as BrandName,D.CatName as CategoryName from Products A inner join Brand C on C.BrandID = A.PBrandID inner join Category D on D.CatID = A.PCategoryID cross apply( select top 1 * from ProductImages B where B.PID = A.PID order by B.PID desc)B where CatName='Saree'AND (PSelPrice between 2000 and 2500) order by A.PID desc";
                SqlCommand cmd = new SqlCommand(query, con);
                SqlDataReader dt = cmd.ExecuteReader();
        ...
        protected void r6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select A.*,B.*,C.Name ,A.PPrice-A.PSelPrice as DiscAmount,B.Name as ImageName, C.Name as BrandName,D.CatName as CategoryName from Products A inner join Brand C on C.BrandID = A.PBrandID inner join Category D on D.CatID = A.PCategoryID cross apply( select top 1 * from ProductImages B where B.PID = A.PID order by B.PID desc)B where CatName='Saree'AND (PSelPrice between 2500 and above) order by A.PID desc";
                SqlCommand cmd = new SqlCommand(query, con);
                SqlDataReader dt = cmd.ExecuteReader();
