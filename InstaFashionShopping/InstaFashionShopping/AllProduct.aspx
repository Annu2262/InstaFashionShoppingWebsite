<%@ Page Title="" Language="C#" MasterPageFile="~/Products.Master" AutoEventWireup="true" CodeBehind="AllProduct.aspx.cs" Inherits="InstaFashionShopping.AllProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" style="margin-left:30px">
                <div class="col-md-12">
                    ...
                    <div class="midsize"> <a href="UserHome.aspx">Home</a> / <span>All</span></div>
                    <h3>
            ...
            <div class="row" style="margin-left: 30px">
                ...
                <asp:TextBox ID="txtFilterGrid1Record" CssClass="form-control" runat="server" placeholder="Search Product" AutoPostBack="true" Style="width: 90%" OnTextChanged="txtFilterGrid1Record_TextChanged"></asp:TextBox>
                <br />
                <hr />
