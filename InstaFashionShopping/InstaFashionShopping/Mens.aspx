<%@ Page Title="" Language="C#" MasterPageFile="~/Products.Master" AutoEventWireup="true" CodeBehind="Mens.aspx.cs" Inherits="InstaFashionShopping.Mens" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" style="margin-left: 30px">
                <div class="col-md-12">
                    <div class="midsize"> <a href="UserHome.aspx">Home</a> / <span>Mens</span></div>
                    <h3>
                        <asp:Label ID="Label1" runat="server" Text="Showing All Mens Products"></asp:Label>
                    </h3>
