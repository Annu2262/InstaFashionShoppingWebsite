<%@ Page Title="" Language="C#" MasterPageFile="~/Products.Master" AutoEventWireup="true" CodeBehind="Kurta.aspx.cs" Inherits="InstaFashionShopping.Kurta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
              <div class="row" style="margin-left:30px">
                <div class="col-md-12">
                    <div class="midsize"> <a href="UserHome.aspx">Home</a> / <span>Kurtas and Kurta Sets</span></div>
                    <h3>
                                                ...
                                                <div class="card-heading">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="shop__sidebar__categories">
                                                            ...
                                                            <li>&nbsp; <a href="Product.aspx">All</a></li>
                                                                <li>&nbsp; <a href="Mens.aspx">Mens</a></li>
                                                                <li>&nbsp; <a href="Womens.aspx">Womens</a></li>
